...
from infer_kandinsky_2_image_mixing.infer_kandinsky_2_image_mixing_process import InferKandinsky2ImageMixingParam
...
# --------------------
class InferKandinsky2ImageMixingWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = InferKandinsky2ImageMixingParam()
        else:
        ...
        # Weights
        self.edit_weights = pyqtutils.append_edit(self.grid_layout, "Weights [prompt, img1, img2]", self.parameters.weights)
    ...
    def on_apply(self):
        ...
        self.parameters.weights = self.edit_weights.text()
...
# --------------------
class InferKandinsky2ImageMixingWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the algorithm name attribute -> it must be the same as the one declared in the algorithm factory class
        self.name = "infer_kandinsky_2_image_mixing"

    def create(self, param):
        # Create widget object
        return InferKandinsky2ImageMixingWidget(param, None)
